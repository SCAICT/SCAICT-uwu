...
class SendGift(build.build.Build):
    ...
    class Gift(discord.ui.View):
        ...
        def __get_btn_attr(self, btn_id: int) -> (
            ...
            Returns:
                tuple[None, None] | tuple[mysql.connector.types.RowItemType | typing.Any, mysql.connector.types.RowItemType | typing.Any]:
            """
    ...
    def cache_users_by_name(self) -> dict[str, discord.User]:
        """
        Returns:
